...
def run_iteration_tests(passwords, max_iterations, csv_filename="hash_comparison.csv"):
...
if __name__ == "__main__":
    passwords = ["J8t$4wZ!N3bL9@cP"]
    methods = ["SHA256", "bcrypt", "scrypt", "Argon2", "Plot-only", "Plot+Argon2"]
    run_iteration_tests(passwords, max_iterations=100, csv_filename="hash_comparison.csv")
