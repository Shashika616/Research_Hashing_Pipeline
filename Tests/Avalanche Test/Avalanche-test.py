...
if __name__ == "__main__":
    pairs = [
        ("abc", "abb"), ("abc", "abd"), ("abc", "aac"), ("abc", "aak"),
        ("abc", "adv"), ("password", "passwod"), ("password", "passWord"),
        ("password", "password1"), ("password", "passw0rd"), ("aaa", "aab"),
    ]
    run_avalanche_tests(pairs=pairs, repetitions=10, iterations=2, normalization_method="log", csv_filename="avalanche_results.csv")